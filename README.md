...
| `Fig3_S9_S16.zip` | Fig. 3, Fig. S9, Fig. S16 | Table S3 |
| `Fig4a.zip` / `Fig4b.zip` | Fig. 4a, Fig. 4b | — |
| `Fig5_Fig6.zip` | Fig. 5, Fig. 6 | — |
| `Fig7c_S20_S21_S22_S23_S24.zip` | Fig. 7c, Fig. S20–S24 | Table S4, Table S5 |
| `FigS10_S11.zip` | Fig. S10, S11 | Table S1, Table S2 |
| `FigS12.zip` | Fig. S12 | — |
| `FigS13_S14.zip` | Fig. S13, S14 | — |
| `FigS15.zip` | Fig. S15 | — |
| `FigS17.zip` | Fig. S17 | — |
| `FigS18.zip` | Fig. S18 | — |
| `FigS19.zip` | Fig. S19 | — |

**No code / data (figure itself is the content):** Fig. S7 (workflow), Fig. S7/S8 photographs (sediment / sampling-method).

> Note: the previous Extended Data (ED) figures have been merged into the
> main and Supplementary series. ED Fig. 1 → **Fig. S2**; ED Fig. 2
> (workflow) → **Fig. S9**; ED Fig. 3 → **Fig. 5**; ED Fig. 4 → **Fig. 6**;
> ED Fig. 5 → **Fig. S20**. Former Fig. 5 (SR/SEM) → **Fig. 7**; the
> conceptual model is **Fig. 8**.
...
*(If S7/S8 split differs in the final manuscript, adjust S7–S9 accordingly; the SEM block S20–S24 is fixed as above.)*
...
| `Supp_Fig_S22_SR_pair_composition.R` | Fig. S22 (SR pair composition) |
...
- `phase6b_full_path_coefs.csv` (567,651 rows; full path coefficients — source of Fig. 7c / S23 values)
